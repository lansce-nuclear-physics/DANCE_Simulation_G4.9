...
#ifndef DANCEPhysListParticles_h
#define DANCEPhysListParticles_h 1
...
class DANCEPhysListParticles : public G4VPhysicsConstructor
{
public: 
  DANCEPhysListParticles(const G4String& name = "particles");
  virtual ~DANCEPhysListParticles();
