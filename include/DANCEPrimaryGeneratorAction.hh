...
//
//
// $Id: DANCEPrimaryGeneratorAction.hh,v 1.4 2002/01/09 17:23:48 ranjard Exp $
// GEANT4 tag $Name: geant4-08-00 $
//

#ifndef DANCEPrimaryGeneratorAction_h
#define DANCEPrimaryGeneratorAction_h 1
...
class DANCEPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    DANCEPrimaryGeneratorAction();
    ~DANCEPrimaryGeneratorAction();
  ...
  private:
    ...
    G4GeneralParticleSource* sourceGun;
